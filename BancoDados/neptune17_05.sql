...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 17-Maio-2024 às 20:43
...
--
CREATE DATABASE IF NOT EXISTS `neptune` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `neptune`;
...
INSERT INTO `alerta` (`Alerta_id`, `Horario`, `Tipo`, `Quantidade`, `Anotacao`, `Data_alerta`, `Tanque`) VALUES
...
INSERT INTO `tanque` (`Nome`, `Tanque_id`, `Capacidade_volume`, `Piscicultura_id`) VALUES
('Tanque 1', 9, '20.00', 5),
('Tanque 2', 10, '50.00', 6),
('Tanque 3', 11, '80.00', 7);
...
(1, NULL, '', '00:00:00', '2024-04-03', 0),
(2, 9, '', '00:00:00', '2024-04-03', 0),
(3, 9, '', '00:00:00', '2024-04-03', 0),
(4, 9, 'tipoTeste', '17:58:59', '2024-05-17', 0),
(5, NULL, 'breno', '15:50:00', '2024-05-17', 0),
(6, 11, 'bruno', '15:48:00', '2024-05-17', 0);
